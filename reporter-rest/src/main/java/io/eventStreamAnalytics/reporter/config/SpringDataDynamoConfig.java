 ...
 */
package io.eventStreamAnalytics.reporter.config;
 ...
 */
@Configuration
@EnableDynamoDBRepositories(basePackages = "io.eventStreamAnalytics.reporter")
public class SpringDataDynamoConfig {

    @Value("${amazon.aws.amazonDynamoDBEndpoint}")
	private String amazonDynamoDBEndpoint;

    @Value("${amazon.aws.amazonAWSAccessKey}")
	private String amazonAWSAccessKey;

    @Value("${amazon.aws.amazonAWSSecretKey}")
